                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <img src="\storage\services\eco-ecology-mountain-svgrepo-com.svg" alt="" sizes="100vw" srcset="\storage\services\eco-ecology-mountain-svgrepo-com.svg 1x, \storage\services\eco-ecology-mountain-svgrepo-com.svg 2x" class="h-12 w-auto lg:h-16 lg:w-16">                            
                        </div>
                        @if (Route::has('login'))
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img src="\storage\services\welcome.jpg" alt="Imagen de promoción">
                                </div>

                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black dark:text-white"><strong>Descubre El Guavio: Tu puerta de entrada a la naturaleza, la cultura y la aventura</strong></h2>
                                            <p class="mt-4 text-sm/relaxed">
                                                
                                                Bienvenido a la plataforma oficial de turismo de El Guavio, una región llena de paisajes impresionantes, tradiciones auténticas y experiencias únicas que esperan ser descubiertas. En esta página web, conectamos a los prestadores de servicios turísticos con los visitantes que buscan explorar todo lo que esta maravillosa región tiene para ofrecer.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <img src="\storage\services\providers.png" alt="Providers">
                                </div>
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white"><strong>Para los prestadores de servicios:</strong></h2>
                                    <p class="mt-4 text-sm/relaxed">
                                        Si eres un prestador de servicios turísticos en El Guavio, esta plataforma es tu aliada perfecta. Aquí podrás gestionar y promocionar tus servicios de manera fácil y eficiente. Desde alojamientos y restaurantes hasta actividades de aventura y tours culturales, nuestra herramienta te permite llegar a más visitantes y mostrarles por qué El Guavio es un destino que no pueden perderse.
                                    </p>
                                </div>
                            </a>
                            ...
                            <a
                                ...
                                class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <img src="\storage\services\Users.png" alt="users">
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white"><strong>Para los Visitantes:</strong></h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        ¿Listo para vivir una experiencia inolvidable? En esta plataforma encontrarás todo lo que necesitas para planificar tu viaje a El Guavio. Explora nuestra amplia oferta de servicios turísticos, desde recorridos por cascadas y senderos ecológicos hasta degustaciones de gastronomía local y actividades culturales. Conéctate directamente con los prestadores de servicios, reserva con facilidad y prepárate para descubrir los secretos mejor guardados de esta región.
                                    </p>
                                </div>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <img src="\storage\services\About.png" alt="users">
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white"><strong>¿Qué encontrarás aquí?</strong></h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        <li>Servicios turísticos: Alojamientos, restaurantes, guías turísticos, actividades de aventura y más.</li>
                                        <li>Información detallada: Descripciones, fotos, precios y reseñas de cada servicio.</li>
                                        <li>Contacto directo: Comunícate fácilmente con los prestadores de servicios para resolver dudas o hacer reservas.</li>
                                        <li>Actualizaciones en tiempo real: Los prestadores pueden mantener su información actualizada para ofrecer siempre lo mejor a los visitantes.</li>
                                    </p>
                                </div>
                            </div>
                        </div>
